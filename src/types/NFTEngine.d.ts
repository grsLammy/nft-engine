...
interface NFTEngineInterface extends ethers.utils.Interface {
  functions: {
    ...
    "transferMultipleNFTs(address,address,uint256[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "transferMultipleNFTs",
    values: [string, string, BigNumberish[]]
  ): string;
  encodeFunctionData(
...
export class NFTEngine extends BaseContract {
  ...
  functions: {
    ...
    hashes(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
